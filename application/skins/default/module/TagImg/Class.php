...
class Skin_Module_TagImg_Class extends Aitsu_Ee_Module_Abstract {
	...
	public static function init($context) {
		...
		$display = Aitsu_Content_Config_Select :: set($index, 'ImgDisplay', 'Display', array (
			'block' => 'block',
			'inline' => 'inline'
		), 'Backend options');
		...
		if (!$instance->_get('Img' . preg_replace('/[^a-zA-Z_0-9]/', '', $index), $output)) {
			...
			$transform = Aitsu_Content_Config_Select :: set($index, 'ImgTransform', 'Transform', array (
				'Scale to fit' => '0',
				'Cut to size' => '1',
				'Cut to focus' => '2'
			), 'Choose image transformation');
			...
			$thumbTransform = Aitsu_Content_Config_Select :: set($index, 'ImgThumbTransform', 'Transform', array (
				'Scale to fit' => '0',
				'Cut to size' => '1',
				'Cut to focus' => '2'
			), 'Choose thumb transformation');
