			...
			$.prettySociable.settings = jQuery.extend({
				...
				websites: {
					facebook : {
						...
						'icon':'?url?/Images/prettySociable/large_icons/facebook.png',
					...
					twitter : {
						...
						'icon':'?url?/Images/prettySociable/large_icons/twitter.png',
						'sizes':{'width':70,'height':70}
					},
					delicious : {
						'active': true,
						...
						'icon':'?url?/Images/prettySociable/large_icons/delicious.png',
						'sizes':{'width':70,'height':70}
					},
					digg : {
						'active': true,
						...
						'icon':'?url?/Images/prettySociable/large_icons/digg.png',
						'sizes':{'width':70,'height':70}
					},
					linkedin : {
						'active': true,
						...
						'icon':'?url?/Images/prettySociable/large_icons/linkedin.png',
						'sizes':{'width':70,'height':70}
					},
					reddit : {
						'active': true,
						...
						'icon':'?url?/Images/prettySociable/large_icons/reddit.png',
						'sizes':{'width':70,'height':70}
					},
					stumbleupon : {
						'active': true,
						...
						'icon':'?url?/Images/prettySociable/large_icons/stumbleupon.png',
						'sizes':{'width':70,'height':70}
					},
					tumblr : {
						'active': true,
						...
						'icon':'?url?/Images/prettySociable/large_icons/tumblr.png',
						'sizes':{'width':70,'height':70}
					}
				},
				tooltip: {
