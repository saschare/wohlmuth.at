 ...
 *
 * {@id $Id: Class.php 17747 2010-07-27 12:09:25Z akm $}
 */

class Aitsu_Ee_Module_Template_Class extends Aitsu_Ee_Module_Abstract {

	public static function about() {

		return (object) array (
			'name' => 'Template',
			'description' => Zend_Registry :: get('Zend_Translate')->translate('Outputs the content of the default template or the specified template, if configured accordingly.'),
			'type' => 'Layout',
			'author' => (object) array (
				'name' => 'Andreas Kummer',
			...
			'status' => 'stable',
			'url' => null,
			'id' => 'a0725374-c565-11df-851a-0800200c9a66'
		);
	}
