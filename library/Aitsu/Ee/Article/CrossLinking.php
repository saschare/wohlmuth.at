...
class Aitsu_Ee_Article_CrossLinking {
	...
	public static function getEditData() {
		...
		'	) as article ' .
		'left join _ee_crosslink as crosslink on article.idart = crosslink.idartsrc or article.idart = crosslink.idartdest ' .
		'where ' .
		'	( ' .
		'		crosslink.idartsrc = ? ' .
	...
	public static function getLinkedArticles() {
		...
		"	artlang.pagetitle, " .
		"	artlang.summary  " .
		"from _ee_crosslink as crosslink " .
