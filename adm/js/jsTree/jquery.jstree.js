	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' + 
				...
				'.jstree li { display:block; min-height:21px; line-height:18px; white-space:nowrap; margin-left:18px; } ' + 
				...
				'.jstree a > .jstree-icon { margin-right:4px; } ' + 
				'.jstree-rtl a > .jstree-icon { margin-left:4px; margin-right:0; } ' + 
		...
		if(/msie/.test(u) && parseInt(v, 10) == 6) { 
			is_ie6 = true;
			css_string += '' + 
				'.jstree li { height:21px; margin-left:0; margin-right:0; } ' + 
